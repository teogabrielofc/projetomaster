...
.method static constructor <clinit>()V
    ...
    sput v0, Landroid/support/v4/app/av;->b:I
...
.method private static a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    :cond_1
    sget v2, Landroid/support/v4/app/av;->b:I
...
.method public a(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;)Landroid/os/Parcelable;
    ...
    invoke-static {v1}, Landroid/support/v4/app/av;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    sget v3, Landroid/support/v4/app/av;->b:I
    ...
    iget-object v3, p0, Landroid/support/v4/app/av;->a:Landroid/graphics/Matrix;
    ...
    iput-object v3, p0, Landroid/support/v4/app/av;->a:Landroid/graphics/Matrix;
    ...
    iget-object v2, p0, Landroid/support/v4/app/av;->a:Landroid/graphics/Matrix;
...
.method public a(Ljava/util/List;Ljava/util/List;Landroid/support/v4/app/av$a;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p3}, Landroid/support/v4/app/av$a;->a()V
