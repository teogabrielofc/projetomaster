...
# direct methods
.method public constructor <init>(Landroid/support/v4/app/ab;ILandroid/os/Bundle;Landroid/support/v4/app/aa$a;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    iput p2, p0, Landroid/support/v4/app/ab$a;->a:I

    iput-object p3, p0, Landroid/support/v4/app/ab$a;->b:Landroid/os/Bundle;

    iput-object p4, p0, Landroid/support/v4/app/ab$a;->c:Landroid/support/v4/app/aa$a;
...
.method a()V
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/ab$a;->d:Landroid/support/v4/b/i;
    ...
    iget-object v2, p0, Landroid/support/v4/app/ab$a;->b:Landroid/os/Bundle;

    invoke-interface {v0, v1, v2}, Landroid/support/v4/app/aa$a;->a(ILandroid/os/Bundle;)Landroid/support/v4/b/i;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/ab$a;->d:Landroid/support/v4/b/i;
    ...
    iget-object v2, p0, Landroid/support/v4/app/ab$a;->d:Landroid/support/v4/b/i;
...
.method public a(Landroid/support/v4/b/i;)V
    ...
    iget-object v0, v0, Landroid/support/v4/app/ab;->b:Landroid/support/v4/f/l;
    ...
    iget-object v1, v1, Landroid/support/v4/app/ab;->b:Landroid/support/v4/f/l;

    iget v2, p0, Landroid/support/v4/app/ab$a;->a:I

    invoke-virtual {v1, v2, v4}, Landroid/support/v4/f/l;->b(ILjava/lang/Object;)V

    invoke-virtual {p0}, Landroid/support/v4/app/ab$a;->f()V
...
.method public a(Landroid/support/v4/b/i;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/app/ab$a;->b(Landroid/support/v4/b/i;Ljava/lang/Object;)V

    :cond_7
    iget-object v0, p0, Landroid/support/v4/app/ab$a;->o:Landroid/support/v4/app/ab;

    iget-object v0, v0, Landroid/support/v4/app/ab;->c:Landroid/support/v4/f/l;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/f/l;->c(I)V

    :cond_8
    iget-object v0, p0, Landroid/support/v4/app/ab$a;->o:Landroid/support/v4/app/ab;

    iget-object v0, v0, Landroid/support/v4/app/ab;->h:Landroid/support/v4/app/s;
...
.method b()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/ab$a;->i:Z

    iget-boolean v0, p0, Landroid/support/v4/app/ab$a;->h:Z

    iput-boolean v0, p0, Landroid/support/v4/app/ab$a;->j:Z

    const/4 v0, 0x0

    iput-boolean v0, p0, Landroid/support/v4/app/ab$a;->h:Z

    const/4 v0, 0x0

    iput-object v0, p0, Landroid/support/v4/app/ab$a;->c:Landroid/support/v4/app/aa$a;
...
.method b(Landroid/support/v4/b/i;Ljava/lang/Object;)V
    ...
    iget-object v1, v1, Landroid/support/v4/app/ab;->h:Landroid/support/v4/app/s;
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/aa$a;->a(Landroid/support/v4/b/i;Ljava/lang/Object;)V
    :try_end_0
    ...
    iget-object v2, v2, Landroid/support/v4/app/ab;->h:Landroid/support/v4/app/s;
...
.method c()V
    ...
    iget-boolean v1, p0, Landroid/support/v4/app/ab$a;->j:Z
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/ab$a;->e()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/ab$a;->g:Ljava/lang/Object;

    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/ab$a;->b(Landroid/support/v4/b/i;Ljava/lang/Object;)V
...
.method d()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/ab$a;->k:Z
...
.method f()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/ab$a;->l:Z
    ...
    iget-object v1, p0, Landroid/support/v4/app/ab$a;->d:Landroid/support/v4/b/i;
    ...
    iget-object v3, p0, Landroid/support/v4/app/ab$a;->d:Landroid/support/v4/b/i;

    invoke-interface {v0, v3}, Landroid/support/v4/app/aa$a;->a(Landroid/support/v4/b/i;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
