.class Landroid/support/v4/app/ah$k;
.super Landroid/support/v4/app/ah$j;
...
.method constructor <init>()V
    ...
    invoke-direct {p0}, Landroid/support/v4/app/ah$j;-><init>()V
...
.method public a(Landroid/support/v4/app/ah$d;Landroid/support/v4/app/ah$e;)Landroid/app/Notification;
    ...
    iget-object v5, v0, Landroid/support/v4/app/ah$d;->b:Ljava/lang/CharSequence;

    move-object/from16 v0, p1

    iget-object v6, v0, Landroid/support/v4/app/ah$d;->c:Ljava/lang/CharSequence;
    ...
    iget-object v0, v0, Landroid/support/v4/app/ah$d;->x:Ljava/lang/String;
    ...
    iget v0, v0, Landroid/support/v4/app/ah$d;->z:I

    move/from16 v24, v0

    move-object/from16 v0, p1

    iget v0, v0, Landroid/support/v4/app/ah$d;->A:I

    move/from16 v25, v0

    move-object/from16 v0, p1

    iget-object v0, v0, Landroid/support/v4/app/ah$d;->B:Landroid/app/Notification;
    ...
    iget-object v0, v0, Landroid/support/v4/app/ah$d;->o:[Ljava/lang/CharSequence;
    ...
    invoke-static {v2, v3}, Landroid/support/v4/app/ah;->b(Landroid/support/v4/app/ag;Landroid/support/v4/app/ah$q;)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/app/ah$k;->a(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v4

    invoke-virtual {v3, v4}, Landroid/support/v4/app/ah$q;->a(Landroid/os/Bundle;)V
