...
.field n:Landroid/support/v4/app/s;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/app/u;->q:Ljava/lang/reflect/Field;
    ...
    sput-object v0, Landroid/support/v4/app/u;->E:Landroid/view/animation/Interpolator;
...
.method constructor <init>()V
    ...
    iput v0, p0, Landroid/support/v4/app/u;->m:I

    iput-object v1, p0, Landroid/support/v4/app/u;->z:Landroid/os/Bundle;

    iput-object v1, p0, Landroid/support/v4/app/u;->A:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, Landroid/support/v4/app/u;->C:Ljava/lang/Runnable;
...
.method private A()V
    ...
    iget-object v0, p0, Landroid/support/v4/app/u;->x:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    iget-object v0, p0, Landroid/support/v4/app/u;->w:Ljava/util/ArrayList;
...
.method private B()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/u$e;->d()V
...
.method private a(Ljava/util/ArrayList;Ljava/util/ArrayList;IILandroid/support/v4/f/b;)I
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/h;->f()Z
    ...
    invoke-virtual {v0, p1, v1, p4}, Landroid/support/v4/app/h;->a(Ljava/util/ArrayList;II)Z
    ...
    iput-object v1, p0, Landroid/support/v4/app/u;->B:Ljava/util/ArrayList;

    :cond_0
    new-instance v1, Landroid/support/v4/app/u$e;

    invoke-direct {v1, v0, v5}, Landroid/support/v4/app/u$e;-><init>(Landroid/support/v4/app/h;Z)V

    iget-object v6, p0, Landroid/support/v4/app/u;->B:Ljava/util/ArrayList;

    invoke-virtual {v6, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v0, v1}, Landroid/support/v4/app/h;->a(Landroid/support/v4/app/Fragment$c;)V
    ...
    :cond_1
    invoke-direct {p0, p5}, Landroid/support/v4/app/u;->b(Landroid/support/v4/f/b;)V
    ...
    :cond_3
    invoke-virtual {v0, v3}, Landroid/support/v4/app/h;->b(Z)V
...
.method static a(Landroid/content/Context;FF)Landroid/view/animation/Animation;
    ...
    sget-object v1, Landroid/support/v4/app/u;->E:Landroid/view/animation/Interpolator;
...
.method static a(Landroid/content/Context;FFFF)Landroid/view/animation/Animation;
    ...
    sget-object v1, Landroid/support/v4/app/u;->D:Landroid/view/animation/Interpolator;
...
.method private a(Landroid/support/v4/app/h;ZZZ)V
    .locals 7
    ...
    invoke-static {v1, v2, v3, v4}, Landroid/support/v4/app/u;->b(Ljava/util/ArrayList;Ljava/util/ArrayList;II)V
    ...
    invoke-static/range {v0 .. v5}, Landroid/support/v4/app/y;->a(Landroid/support/v4/app/u;Ljava/util/ArrayList;Ljava/util/ArrayList;IIZ)V

    :cond_0
    if-eqz p4, :cond_1

    iget v0, p0, Landroid/support/v4/app/u;->m:I

    invoke-virtual {p0, v0, v4}, Landroid/support/v4/app/u;->a(IZ)V
    ...
    invoke-virtual {p1, v4}, Landroid/support/v4/app/h;->b(I)Z
...
.method static synthetic a(Landroid/support/v4/app/u;)V
    .locals 0
...
.method static synthetic a(Landroid/support/v4/app/u;Landroid/support/v4/app/h;ZZZ)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Landroid/support/v4/app/u;->a(Landroid/support/v4/app/h;ZZZ)V
...
.method private a(Ljava/lang/RuntimeException;)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/u;->n:Landroid/support/v4/app/s;
...
.method private a(Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    invoke-static {v0}, Landroid/support/v4/app/u$e;->a(Landroid/support/v4/app/u$e;)Z

    move-result v1

    if-nez v1, :cond_1

    invoke-static {v0}, Landroid/support/v4/app/u$e;->b(Landroid/support/v4/app/u$e;)Landroid/support/v4/app/h;
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/u$e;->e()V
    ...
    :cond_1
    invoke-virtual {v0}, Landroid/support/v4/app/u$e;->c()Z
    ...
    invoke-virtual {v1, p1, v2, v5}, Landroid/support/v4/app/h;->a(Ljava/util/ArrayList;II)Z
...
.method private a(Ljava/util/ArrayList;Ljava/util/ArrayList;II)V
    ...
    iget-boolean v8, v0, Landroid/support/v4/app/h;->u:Z

    iget-object v0, p0, Landroid/support/v4/app/u;->y:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/support/v4/app/u;->y:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Landroid/support/v4/app/u;->y:Ljava/util/ArrayList;

    invoke-virtual {v0, v1}, Landroid/support/v4/app/h;->a(Ljava/util/ArrayList;)V

    :goto_2
    if-nez v7, :cond_1

    iget-boolean v0, v0, Landroid/support/v4/app/h;->j:Z
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/h;->b(Ljava/util/ArrayList;)V
    ...
    :cond_6
    invoke-static {p1, p2, p3, p4}, Landroid/support/v4/app/u;->b(Ljava/util/ArrayList;Ljava/util/ArrayList;II)V
    ...
    invoke-direct {p0, v5}, Landroid/support/v4/app/u;->b(Landroid/support/v4/f/b;)V
    ...
    invoke-direct/range {v0 .. v5}, Landroid/support/v4/app/u;->a(Ljava/util/ArrayList;Ljava/util/ArrayList;IILandroid/support/v4/f/b;)I

    move-result v4

    invoke-direct {p0, v5}, Landroid/support/v4/app/u;->a(Landroid/support/v4/f/b;)V
    ...
    invoke-virtual {p0, v0, v6}, Landroid/support/v4/app/u;->a(IZ)V
    ...
    invoke-virtual {p0, v1}, Landroid/support/v4/app/u;->c(I)V

    const/4 v1, -0x1

    iput v1, v0, Landroid/support/v4/app/h;->n:I
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/u;->j()V
...
.method static a(Landroid/view/View;Landroid/view/animation/Animation;)Z
    ...
    invoke-static {p0}, Landroid/support/v4/view/af;->g(Landroid/view/View;)I

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p0}, Landroid/support/v4/view/af;->u(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p1}, Landroid/support/v4/app/u;->a(Landroid/view/animation/Animation;)Z
...
.method private a(Ljava/lang/String;II)Z
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/u;->h()Z

    invoke-direct {p0, v6}, Landroid/support/v4/app/u;->c(Z)V

    iget-object v1, p0, Landroid/support/v4/app/u;->w:Ljava/util/ArrayList;

    iget-object v2, p0, Landroid/support/v4/app/u;->x:Ljava/util/ArrayList;
    ...
    iput-boolean v6, p0, Landroid/support/v4/app/u;->d:Z
    ...
    invoke-direct {p0, v1, v2}, Landroid/support/v4/app/u;->b(Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    :try_end_0
...
.method private b(Landroid/view/View;Landroid/view/animation/Animation;)V
    ...
    :cond_1
    invoke-static {p1, p2}, Landroid/support/v4/app/u;->a(Landroid/view/View;Landroid/view/animation/Animation;)Z
    ...
    :try_start_0
    sget-object v0, Landroid/support/v4/app/u;->q:Ljava/lang/reflect/Field;
    ...
    invoke-static {p1, v2, v1}, Landroid/support/v4/view/af;->a(Landroid/view/View;ILandroid/graphics/Paint;)V

    new-instance v1, Landroid/support/v4/app/u$a;

    invoke-direct {v1, p1, p2, v0}, Landroid/support/v4/app/u$a;-><init>(Landroid/view/View;Landroid/view/animation/Animation;Landroid/view/animation/Animation$AnimationListener;)V
...
.method private b(Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    :cond_3
    invoke-direct {p0, p1, p2}, Landroid/support/v4/app/u;->a(Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    iget-boolean v0, v0, Landroid/support/v4/app/h;->u:Z

    if-nez v0, :cond_7

    if-eq v1, v2, :cond_4

    invoke-direct {p0, p1, p2, v1, v2}, Landroid/support/v4/app/u;->a(Ljava/util/ArrayList;Ljava/util/ArrayList;II)V
    ...
    invoke-direct {p0, p1, p2, v2, v0}, Landroid/support/v4/app/u;->a(Ljava/util/ArrayList;Ljava/util/ArrayList;II)V
    ...
    invoke-direct {p0, p1, p2, v1, v3}, Landroid/support/v4/app/u;->a(Ljava/util/ArrayList;Ljava/util/ArrayList;II)V
...
.method private static b(Ljava/util/ArrayList;Ljava/util/ArrayList;II)V
    ...
    :cond_1
    invoke-virtual {v0, v2}, Landroid/support/v4/app/h;->a(I)V
...
.method private c(Z)V
    ...
    iget-object v1, p0, Landroid/support/v4/app/u;->n:Landroid/support/v4/app/s;
    ...
    invoke-direct {p0}, Landroid/support/v4/app/u;->y()V
    ...
    iput-object v0, p0, Landroid/support/v4/app/u;->w:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Landroid/support/v4/app/u;->x:Ljava/util/ArrayList;
    ...
    :try_start_0
    invoke-direct {p0, v0, v1}, Landroid/support/v4/app/u;->a(Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iput-boolean v2, p0, Landroid/support/v4/app/u;->d:Z
...
.method private c(Ljava/util/ArrayList;Ljava/util/ArrayList;)Z
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/u$c;->a(Ljava/util/ArrayList;Ljava/util/ArrayList;)Z
    ...
    iget-object v2, p0, Landroid/support/v4/app/u;->C:Ljava/lang/Runnable;
...
.method private z()V
    ...
    :try_start_0
    iget-object v2, p0, Landroid/support/v4/app/u;->B:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Landroid/support/v4/app/u;->C:Ljava/lang/Runnable;
...
.method public a()Landroid/support/v4/app/x;
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/app/h;-><init>(Landroid/support/v4/app/u;)V
...
.method public a(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    sget-object v1, Landroid/support/v4/app/u$b;->a:[I
    ...
    iput-object v0, v4, Landroid/support/v4/app/Fragment;->mHost:Landroid/support/v4/app/s;
    ...
    iput-object v1, v0, Landroid/support/v4/app/Fragment;->mHost:Landroid/support/v4/app/s;
    ...
    invoke-virtual {v1}, Landroid/support/v4/app/s;->i()Landroid/content/Context;
    ...
    :cond_c
    invoke-virtual {p0, v1}, Landroid/support/v4/app/u;->b(Landroid/support/v4/app/Fragment;)V
...
.method public a(II)V
    ...
    invoke-direct {v0, p0, v1, p1, p2}, Landroid/support/v4/app/u$d;-><init>(Landroid/support/v4/app/u;Ljava/lang/String;II)V

    const/4 v1, 0x0

    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/u;->a(Landroid/support/v4/app/u$c;Z)V
...
.method public a(ILandroid/support/v4/app/h;)V
    ...
    iput-object v1, p0, Landroid/support/v4/app/u;->k:Ljava/util/ArrayList;
...
.method a(IZ)V
    ...
    :cond_2
    iput p1, p0, Landroid/support/v4/app/u;->m:I
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/app/u;->d(Landroid/support/v4/app/Fragment;)V

    iget-object v5, v0, Landroid/support/v4/app/Fragment;->mLoaderManager:Landroid/support/v4/app/ab;

    if-eqz v5, :cond_9

    iget-object v0, v0, Landroid/support/v4/app/Fragment;->mLoaderManager:Landroid/support/v4/app/ab;
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/u;->g()V
...
.method a(Landroid/os/Parcelable;Landroid/support/v4/app/v;)V
    .locals 10
    ...
    invoke-virtual {p2}, Landroid/support/v4/app/v;->a()Ljava/util/List;

    move-result-object v6

    invoke-virtual {p2}, Landroid/support/v4/app/v;->b()Ljava/util/List;
    ...
    iget-object v9, p0, Landroid/support/v4/app/u;->n:Landroid/support/v4/app/s;

    invoke-virtual {v9}, Landroid/support/v4/app/s;->i()Landroid/content/Context;
    ...
    :goto_5
    iget-object v6, p0, Landroid/support/v4/app/u;->n:Landroid/support/v4/app/s;

    iget-object v7, p0, Landroid/support/v4/app/u;->p:Landroid/support/v4/app/Fragment;

    invoke-virtual {v5, v6, v7, v0}, Landroid/support/v4/app/FragmentState;->a(Landroid/support/v4/app/s;Landroid/support/v4/app/Fragment;Landroid/support/v4/app/v;)Landroid/support/v4/app/Fragment;

    move-result-object v0

    sget-boolean v6, Landroid/support/v4/app/u;->a:Z
    ...
    :cond_7
    iget-object v6, p0, Landroid/support/v4/app/u;->e:Ljava/util/ArrayList;
    ...
    iget-object v7, p0, Landroid/support/v4/app/u;->e:Ljava/util/ArrayList;
    ...
    :cond_11
    iget-object v3, p0, Landroid/support/v4/app/u;->f:Ljava/util/ArrayList;
    ...
    :cond_13
    iput-object v4, p0, Landroid/support/v4/app/u;->f:Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, p0}, Landroid/support/v4/app/BackStackState;->a(Landroid/support/v4/app/u;)Landroid/support/v4/app/h;
    ...
    iget v5, v1, Landroid/support/v4/app/h;->n:I
    ...
    :cond_15
    iget-object v3, p0, Landroid/support/v4/app/u;->h:Ljava/util/ArrayList;

    invoke-virtual {v3, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget v3, v1, Landroid/support/v4/app/h;->n:I

    if-ltz v3, :cond_16

    iget v3, v1, Landroid/support/v4/app/h;->n:I

    invoke-virtual {p0, v3, v1}, Landroid/support/v4/app/u;->a(ILandroid/support/v4/app/h;)V
    ...
    :cond_17
    iput-object v4, p0, Landroid/support/v4/app/u;->h:Ljava/util/ArrayList;
...
.method public a(Landroid/support/v4/app/Fragment;)V
    ...
    iget v2, p0, Landroid/support/v4/app/u;->m:I
...
.method a(Landroid/support/v4/app/Fragment;IIIZ)V
    ...
    iput-object v0, p1, Landroid/support/v4/app/Fragment;->mHost:Landroid/support/v4/app/s;

    iget-object v0, p0, Landroid/support/v4/app/u;->p:Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {p0, p1, v0, v3}, Landroid/support/v4/app/u;->a(Landroid/support/v4/app/Fragment;Landroid/content/Context;Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/app/s;->b(Landroid/support/v4/app/Fragment;)V
    ...
    invoke-virtual {p0, p1, v0, v3}, Landroid/support/v4/app/u;->b(Landroid/support/v4/app/Fragment;Landroid/content/Context;Z)V
    ...
    invoke-virtual {p0, p1, v0, v3}, Landroid/support/v4/app/u;->a(Landroid/support/v4/app/Fragment;Landroid/os/Bundle;Z)V
    ...
    invoke-static {v0, v3}, Landroid/support/v4/view/af;->a(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0, p1, v0, v1, v3}, Landroid/support/v4/app/u;->a(Landroid/support/v4/app/Fragment;Landroid/view/View;Landroid/os/Bundle;Z)V
    ...
    :cond_10
    iget-object v0, p0, Landroid/support/v4/app/u;->o:Landroid/support/v4/app/q;
    ...
    invoke-static {v1, v3}, Landroid/support/v4/view/af;->a(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0, p1, v0, v3}, Landroid/support/v4/app/u;->b(Landroid/support/v4/app/Fragment;Landroid/os/Bundle;Z)V
    ...
    invoke-virtual {p0, p1, v3}, Landroid/support/v4/app/u;->b(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-virtual {p0, p1, v3}, Landroid/support/v4/app/u;->c(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-static {v0}, Landroid/support/v4/app/ae;->a(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    invoke-static {v1}, Landroid/support/v4/app/ae;->a(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    invoke-virtual {p0, p1, v3}, Landroid/support/v4/app/u;->d(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-virtual {p0, p1, v3}, Landroid/support/v4/app/u;->e(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/app/s;->a(Landroid/support/v4/app/Fragment;)Z
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/app/u;->l(Landroid/support/v4/app/Fragment;)V

    :cond_2c
    invoke-virtual {p1}, Landroid/support/v4/app/Fragment;->performDestroyView()V

    invoke-virtual {p0, p1, v3}, Landroid/support/v4/app/u;->f(Landroid/support/v4/app/Fragment;Z)V
    ...
    new-instance v2, Landroid/support/v4/app/u$2;

    invoke-direct {v2, p0, v1, v0, p1}, Landroid/support/v4/app/u$2;-><init>(Landroid/support/v4/app/u;Landroid/view/View;Landroid/view/animation/Animation;Landroid/support/v4/app/Fragment;)V
    ...
    invoke-virtual {p0, p1, v3}, Landroid/support/v4/app/u;->g(Landroid/support/v4/app/Fragment;Z)V

    :goto_e
    invoke-virtual {p1}, Landroid/support/v4/app/Fragment;->performDetach()V

    invoke-virtual {p0, p1, v3}, Landroid/support/v4/app/u;->h(Landroid/support/v4/app/Fragment;Z)V
    ...
    :cond_32
    iput-object v7, p1, Landroid/support/v4/app/Fragment;->mHost:Landroid/support/v4/app/s;
...
.method a(Landroid/support/v4/app/Fragment;Landroid/content/Context;Z)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/Fragment;->getFragmentManager()Landroid/support/v4/app/t;
    ...
    invoke-virtual {v0, p1, p2, v1}, Landroid/support/v4/app/u;->a(Landroid/support/v4/app/Fragment;Landroid/content/Context;Z)V

    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/u;->H:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-virtual {v0, p0, p1, p2}, Landroid/support/v4/app/t$a;->a(Landroid/support/v4/app/t;Landroid/support/v4/app/Fragment;Landroid/content/Context;)V
...
.method a(Landroid/support/v4/app/Fragment;Landroid/os/Bundle;Z)V
    ...
    invoke-virtual {v0, p1, p2, v1}, Landroid/support/v4/app/u;->a(Landroid/support/v4/app/Fragment;Landroid/os/Bundle;Z)V
    ...
    invoke-virtual {v0, p0, p1, p2}, Landroid/support/v4/app/t$a;->a(Landroid/support/v4/app/t;Landroid/support/v4/app/Fragment;Landroid/os/Bundle;)V
...
.method a(Landroid/support/v4/app/Fragment;Landroid/view/View;Landroid/os/Bundle;Z)V
    ...
    invoke-virtual {v0, p1, p2, p3, v1}, Landroid/support/v4/app/u;->a(Landroid/support/v4/app/Fragment;Landroid/view/View;Landroid/os/Bundle;Z)V
    ...
    invoke-virtual {v0, p0, p1, p2, p3}, Landroid/support/v4/app/t$a;->a(Landroid/support/v4/app/t;Landroid/support/v4/app/Fragment;Landroid/view/View;Landroid/os/Bundle;)V
...
.method public a(Landroid/support/v4/app/Fragment;Z)V
    ...
    iput-boolean v4, p0, Landroid/support/v4/app/u;->r:Z
...
.method public a(Landroid/support/v4/app/s;Landroid/support/v4/app/q;Landroid/support/v4/app/Fragment;)V
    .locals 2
    ...
    :cond_0
    iput-object p1, p0, Landroid/support/v4/app/u;->n:Landroid/support/v4/app/s;

    iput-object p2, p0, Landroid/support/v4/app/u;->o:Landroid/support/v4/app/q;

    iput-object p3, p0, Landroid/support/v4/app/u;->p:Landroid/support/v4/app/Fragment;

    return-void
.end method

.method public a(Landroid/support/v4/app/u$c;Z)V
    .locals 2
...
.method public a(Landroid/view/Menu;Landroid/view/MenuInflater;)Z
    ...
    :cond_6
    iput-object v1, p0, Landroid/support/v4/app/u;->i:Ljava/util/ArrayList;
...
.method a(Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/String;II)Z
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/h;->g()Ljava/lang/String;
    ...
    iget-object v2, p0, Landroid/support/v4/app/u;->h:Ljava/util/ArrayList;
...
.method b(Landroid/support/v4/app/Fragment;Landroid/content/Context;Z)V
    ...
    invoke-virtual {v0, p1, p2, v1}, Landroid/support/v4/app/u;->b(Landroid/support/v4/app/Fragment;Landroid/content/Context;Z)V
    ...
    invoke-virtual {v0, p0, p1, p2}, Landroid/support/v4/app/t$a;->b(Landroid/support/v4/app/t;Landroid/support/v4/app/Fragment;Landroid/content/Context;)V
...
.method b(Landroid/support/v4/app/Fragment;Landroid/os/Bundle;Z)V
    ...
    invoke-virtual {v0, p1, p2, v1}, Landroid/support/v4/app/u;->b(Landroid/support/v4/app/Fragment;Landroid/os/Bundle;Z)V
    ...
    invoke-virtual {v0, p0, p1, p2}, Landroid/support/v4/app/t$a;->b(Landroid/support/v4/app/t;Landroid/support/v4/app/Fragment;Landroid/os/Bundle;)V
...
.method b(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-virtual {v0, p1, v1}, Landroid/support/v4/app/u;->b(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-virtual {v0, p0, p1}, Landroid/support/v4/app/t$a;->a(Landroid/support/v4/app/t;Landroid/support/v4/app/Fragment;)V
...
.method public b(Landroid/support/v4/app/u$c;Z)V
    .locals 2

    invoke-direct {p0, p2}, Landroid/support/v4/app/u;->c(Z)V

    iget-object v0, p0, Landroid/support/v4/app/u;->w:Ljava/util/ArrayList;

    iget-object v1, p0, Landroid/support/v4/app/u;->x:Ljava/util/ArrayList;

    invoke-interface {p1, v0, v1}, Landroid/support/v4/app/u$c;->a(Ljava/util/ArrayList;Ljava/util/ArrayList;)Z
    ...
    invoke-direct {p0, v0, v1}, Landroid/support/v4/app/u;->b(Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public b()Z
    ...
    invoke-direct {p0}, Landroid/support/v4/app/u;->B()V
...
.method public c()V
    ...
    invoke-direct {v0, p0, v1, v2, v3}, Landroid/support/v4/app/u$d;-><init>(Landroid/support/v4/app/u;Ljava/lang/String;II)V

    invoke-virtual {p0, v0, v3}, Landroid/support/v4/app/u;->a(Landroid/support/v4/app/u$c;Z)V
...
.method c(Landroid/support/v4/app/Fragment;)V
    ...
    invoke-virtual {p0, p1, v3, v0, v4}, Landroid/support/v4/app/u;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    invoke-direct {p0, v3, v0}, Landroid/support/v4/app/u;->b(Landroid/view/View;Landroid/view/animation/Animation;)V
...
.method c(Landroid/support/v4/app/Fragment;Landroid/os/Bundle;Z)V
    ...
    invoke-virtual {v0, p1, p2, v1}, Landroid/support/v4/app/u;->c(Landroid/support/v4/app/Fragment;Landroid/os/Bundle;Z)V
    ...
    invoke-virtual {v0, p0, p1, p2}, Landroid/support/v4/app/t$a;->c(Landroid/support/v4/app/t;Landroid/support/v4/app/Fragment;Landroid/os/Bundle;)V
...
.method c(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-virtual {v0, p1, v1}, Landroid/support/v4/app/u;->c(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-virtual {v0, p0, p1}, Landroid/support/v4/app/t$a;->b(Landroid/support/v4/app/t;Landroid/support/v4/app/Fragment;)V
...
.method d(Landroid/support/v4/app/Fragment;)V
    ...
    invoke-direct {p0, p1}, Landroid/support/v4/app/u;->n(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {p0, p1, v0, v7, v1}, Landroid/support/v4/app/u;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    invoke-direct {p0, v1, v0}, Landroid/support/v4/app/u;->b(Landroid/view/View;Landroid/view/animation/Animation;)V
...
.method d(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-virtual {v0, p1, v1}, Landroid/support/v4/app/u;->d(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-virtual {v0, p0, p1}, Landroid/support/v4/app/t$a;->c(Landroid/support/v4/app/t;Landroid/support/v4/app/Fragment;)V
...
.method public d()Z
    ...
    invoke-direct {p0, v0, v1, v2}, Landroid/support/v4/app/u;->a(Ljava/lang/String;II)Z
...
.method e(Landroid/support/v4/app/Fragment;)V
    ...
    iget-object v1, p0, Landroid/support/v4/app/u;->p:Landroid/support/v4/app/Fragment;
...
.method e(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-virtual {v0, p1, v1}, Landroid/support/v4/app/u;->e(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-virtual {v0, p0, p1}, Landroid/support/v4/app/t$a;->d(Landroid/support/v4/app/t;Landroid/support/v4/app/Fragment;)V
...
.method f(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-virtual {v0, p1, v1}, Landroid/support/v4/app/u;->f(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-virtual {v0, p0, p1}, Landroid/support/v4/app/t$a;->e(Landroid/support/v4/app/t;Landroid/support/v4/app/Fragment;)V
...
.method g(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-virtual {v0, p1, v1}, Landroid/support/v4/app/u;->g(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-virtual {v0, p0, p1}, Landroid/support/v4/app/t$a;->f(Landroid/support/v4/app/t;Landroid/support/v4/app/Fragment;)V
...
.method h(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-virtual {v0, p1, v1}, Landroid/support/v4/app/u;->h(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-virtual {v0, p0, p1}, Landroid/support/v4/app/t$a;->g(Landroid/support/v4/app/t;Landroid/support/v4/app/Fragment;)V
...
.method public h()Z
    ...
    invoke-direct {p0, v1}, Landroid/support/v4/app/u;->c(Z)V

    const/4 v0, 0x0

    :goto_0
    iget-object v2, p0, Landroid/support/v4/app/u;->w:Ljava/util/ArrayList;

    iget-object v3, p0, Landroid/support/v4/app/u;->x:Ljava/util/ArrayList;

    invoke-direct {p0, v2, v3}, Landroid/support/v4/app/u;->c(Ljava/util/ArrayList;Ljava/util/ArrayList;)Z

    move-result v2

    if-eqz v2, :cond_0

    iput-boolean v1, p0, Landroid/support/v4/app/u;->d:Z
    ...
    invoke-direct {p0, v0, v2}, Landroid/support/v4/app/u;->b(Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method i()V
    ...
    iget-object v4, v0, Landroid/support/v4/app/Fragment;->mLoaderManager:Landroid/support/v4/app/ab;
...
.method j()V
    ...
    check-cast v0, Landroid/support/v4/app/t$b;

    invoke-interface {v0}, Landroid/support/v4/app/t$b;->a()V
...
.method k()Landroid/support/v4/app/v;
    .locals 10
    ...
    :cond_1
    iget-object v6, v0, Landroid/support/v4/app/Fragment;->mChildFragmentManager:Landroid/support/v4/app/u;
    ...
    invoke-direct {v5, v2, v1}, Landroid/support/v4/app/v;-><init>(Ljava/util/List;Ljava/util/List;)V
...
.method l()Landroid/os/Parcelable;
    ...
    invoke-direct {p0}, Landroid/support/v4/app/u;->C()V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/app/u;->m(Landroid/support/v4/app/Fragment;)Landroid/os/Bundle;
    ...
    iget-object v8, p0, Landroid/support/v4/app/u;->f:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, Landroid/support/v4/app/u;->h:Ljava/util/ArrayList;
...
.method l(Landroid/support/v4/app/Fragment;)V
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/u;->A:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, Landroid/support/v4/app/u;->A:Landroid/util/SparseArray;

    :goto_1
    iget-object v0, p1, Landroid/support/v4/app/Fragment;->mInnerView:Landroid/view/View;

    iget-object v1, p0, Landroid/support/v4/app/u;->A:Landroid/util/SparseArray;
...
.method m(Landroid/support/v4/app/Fragment;)Landroid/os/Bundle;
    ...
    iget-object v0, p0, Landroid/support/v4/app/u;->z:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Landroid/support/v4/app/u;->z:Landroid/os/Bundle;
    ...
    invoke-virtual {p0, p1, v0, v2}, Landroid/support/v4/app/u;->c(Landroid/support/v4/app/Fragment;Landroid/os/Bundle;Z)V
...
.method public n()V
    ...
    invoke-virtual {p0, v1, v0}, Landroid/support/v4/app/u;->a(IZ)V
...
.method public v()V
    ...
    iput-boolean v2, p0, Landroid/support/v4/app/u;->t:Z

    invoke-virtual {p0}, Landroid/support/v4/app/u;->h()Z

    iput-boolean v2, p0, Landroid/support/v4/app/u;->d:Z

    invoke-virtual {p0, v0, v0}, Landroid/support/v4/app/u;->a(IZ)V

    iput-boolean v0, p0, Landroid/support/v4/app/u;->d:Z

    iput-object v1, p0, Landroid/support/v4/app/u;->n:Landroid/support/v4/app/s;

    iput-object v1, p0, Landroid/support/v4/app/u;->o:Landroid/support/v4/app/q;

    iput-object v1, p0, Landroid/support/v4/app/u;->p:Landroid/support/v4/app/Fragment;
...
.method x()Landroid/support/v4/view/n;
    .locals 0
