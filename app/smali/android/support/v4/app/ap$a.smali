.class public Landroid/support/v4/app/ap$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZZILjava/lang/CharSequence;ZLjava/util/ArrayList;Landroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    iput-object v4, p0, Landroid/support/v4/app/ap$a;->c:Ljava/util/List;
    ...
    iput-object v4, p0, Landroid/support/v4/app/ap$a;->a:Landroid/app/Notification$Builder;

    new-instance v4, Landroid/os/Bundle;

    invoke-direct {v4}, Landroid/os/Bundle;-><init>()V

    iput-object v4, p0, Landroid/support/v4/app/ap$a;->b:Landroid/os/Bundle;

    if-eqz p20, :cond_0

    iget-object v4, p0, Landroid/support/v4/app/ap$a;->b:Landroid/os/Bundle;
    ...
    iget-object v5, p0, Landroid/support/v4/app/ap$a;->b:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Landroid/support/v4/app/ap$a;->d:Landroid/widget/RemoteViews;

    move-object/from16 v0, p25

    iput-object v0, p0, Landroid/support/v4/app/ap$a;->e:Landroid/widget/RemoteViews;
...
.method public a()Landroid/app/Notification$Builder;
    ...
    iget-object v0, p0, Landroid/support/v4/app/ap$a;->a:Landroid/app/Notification$Builder;

    return-object v0
.end method

.method public a(Landroid/support/v4/app/al$a;)V
    .locals 2

    iget-object v0, p0, Landroid/support/v4/app/ap$a;->c:Ljava/util/List;

    iget-object v1, p0, Landroid/support/v4/app/ap$a;->a:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Landroid/support/v4/app/ao;->a(Landroid/app/Notification$Builder;Landroid/support/v4/app/al$a;)Landroid/os/Bundle;
...
.method public b()Landroid/app/Notification;
    ...
    invoke-static {v0}, Landroid/support/v4/app/ao;->a(Ljava/util/List;)Landroid/util/SparseArray;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v1, p0, Landroid/support/v4/app/ap$a;->b:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Landroid/support/v4/app/ap$a;->d:Landroid/widget/RemoteViews;
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v4/app/ap$a;->e:Landroid/widget/RemoteViews;
