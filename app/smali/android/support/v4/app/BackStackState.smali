...
.method public constructor <init>(Landroid/support/v4/app/h;)V
    ...
    iget-object v1, p1, Landroid/support/v4/app/h;->c:Ljava/util/ArrayList;
    ...
    iget-object v0, p1, Landroid/support/v4/app/h;->c:Ljava/util/ArrayList;
    ...
    iget v6, v0, Landroid/support/v4/app/h$a;->a:I
    ...
    iget v6, v0, Landroid/support/v4/app/h$a;->d:I
    ...
    iget v6, v0, Landroid/support/v4/app/h$a;->e:I
    ...
    :cond_2
    iget v0, p1, Landroid/support/v4/app/h;->h:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->b:I

    iget v0, p1, Landroid/support/v4/app/h;->i:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->c:I

    iget-object v0, p1, Landroid/support/v4/app/h;->l:Ljava/lang/String;
    ...
    iget v0, p1, Landroid/support/v4/app/h;->o:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->f:I

    iget-object v0, p1, Landroid/support/v4/app/h;->p:Ljava/lang/CharSequence;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->g:Ljava/lang/CharSequence;

    iget v0, p1, Landroid/support/v4/app/h;->q:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->h:I

    iget-object v0, p1, Landroid/support/v4/app/h;->r:Ljava/lang/CharSequence;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->i:Ljava/lang/CharSequence;

    iget-object v0, p1, Landroid/support/v4/app/h;->s:Ljava/util/ArrayList;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->j:Ljava/util/ArrayList;

    iget-object v0, p1, Landroid/support/v4/app/h;->t:Ljava/util/ArrayList;
...
# virtual methods
.method public a(Landroid/support/v4/app/u;)Landroid/support/v4/app/h;
    .locals 8
    ...
    invoke-direct {v3, p1}, Landroid/support/v4/app/h;-><init>(Landroid/support/v4/app/u;)V
    ...
    new-instance v4, Landroid/support/v4/app/h$a;

    invoke-direct {v4}, Landroid/support/v4/app/h$a;-><init>()V
    ...
    iput v0, v4, Landroid/support/v4/app/h$a;->a:I
    ...
    iget-object v5, p1, Landroid/support/v4/app/u;->e:Ljava/util/ArrayList;
    ...
    iput-object v0, v4, Landroid/support/v4/app/h$a;->b:Landroid/support/v4/app/Fragment;
    ...
    iput v0, v4, Landroid/support/v4/app/h$a;->c:I
    ...
    iput v0, v4, Landroid/support/v4/app/h$a;->d:I
    ...
    iput v0, v4, Landroid/support/v4/app/h$a;->e:I
    ...
    iput v0, v4, Landroid/support/v4/app/h$a;->f:I

    iget v0, v4, Landroid/support/v4/app/h$a;->c:I

    iput v0, v3, Landroid/support/v4/app/h;->d:I

    iget v0, v4, Landroid/support/v4/app/h$a;->d:I

    iput v0, v3, Landroid/support/v4/app/h;->e:I

    iget v0, v4, Landroid/support/v4/app/h$a;->e:I

    iput v0, v3, Landroid/support/v4/app/h;->f:I

    iget v0, v4, Landroid/support/v4/app/h$a;->f:I

    iput v0, v3, Landroid/support/v4/app/h;->g:I

    invoke-virtual {v3, v4}, Landroid/support/v4/app/h;->a(Landroid/support/v4/app/h$a;)V
    ...
    iput v0, v3, Landroid/support/v4/app/h;->h:I

    iget v0, p0, Landroid/support/v4/app/BackStackState;->c:I

    iput v0, v3, Landroid/support/v4/app/h;->i:I

    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->d:Ljava/lang/String;

    iput-object v0, v3, Landroid/support/v4/app/h;->l:Ljava/lang/String;

    iget v0, p0, Landroid/support/v4/app/BackStackState;->e:I

    iput v0, v3, Landroid/support/v4/app/h;->n:I

    iput-boolean v7, v3, Landroid/support/v4/app/h;->j:Z

    iget v0, p0, Landroid/support/v4/app/BackStackState;->f:I

    iput v0, v3, Landroid/support/v4/app/h;->o:I

    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->g:Ljava/lang/CharSequence;

    iput-object v0, v3, Landroid/support/v4/app/h;->p:Ljava/lang/CharSequence;

    iget v0, p0, Landroid/support/v4/app/BackStackState;->h:I

    iput v0, v3, Landroid/support/v4/app/h;->q:I

    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->i:Ljava/lang/CharSequence;

    iput-object v0, v3, Landroid/support/v4/app/h;->r:Ljava/lang/CharSequence;

    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->j:Ljava/util/ArrayList;

    iput-object v0, v3, Landroid/support/v4/app/h;->s:Ljava/util/ArrayList;

    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->k:Ljava/util/ArrayList;

    iput-object v0, v3, Landroid/support/v4/app/h;->t:Ljava/util/ArrayList;

    iget-boolean v0, p0, Landroid/support/v4/app/BackStackState;->l:Z

    iput-boolean v0, v3, Landroid/support/v4/app/h;->u:Z

    invoke-virtual {v3, v7}, Landroid/support/v4/app/h;->a(I)V
