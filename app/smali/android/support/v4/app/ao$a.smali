...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZILjava/lang/CharSequence;ZLandroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    iput-object v4, p0, Landroid/support/v4/app/ao$a;->c:Ljava/util/List;
    ...
    iput-object v4, p0, Landroid/support/v4/app/ao$a;->b:Landroid/os/Bundle;

    if-eqz p18, :cond_0

    iget-object v4, p0, Landroid/support/v4/app/ao$a;->b:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Landroid/support/v4/app/ao$a;->d:Landroid/widget/RemoteViews;

    move-object/from16 v0, p23

    iput-object v0, p0, Landroid/support/v4/app/ao$a;->e:Landroid/widget/RemoteViews;
...
.method public a(Landroid/support/v4/app/al$a;)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/ao$a;->c:Ljava/util/List;

    iget-object v1, p0, Landroid/support/v4/app/ao$a;->a:Landroid/app/Notification$Builder;
...
.method public b()Landroid/app/Notification;
    ...
    invoke-static {v1}, Landroid/support/v4/app/ao;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/ao$a;->d:Landroid/widget/RemoteViews;
    ...
    :cond_3
    iget-object v0, p0, Landroid/support/v4/app/ao$a;->e:Landroid/widget/RemoteViews;
