...
.field private c:Landroid/support/v4/widget/v;

.field private d:Landroid/support/v4/widget/i;

.field private e:Landroid/support/v4/widget/i;
...
.field private final x:Landroid/support/v4/view/y;

.field private final y:Landroid/support/v4/view/w;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->x:Landroid/support/v4/view/y;

    new-instance v0, Landroid/support/v4/view/w;

    invoke-direct {v0, p0}, Landroid/support/v4/view/w;-><init>(Landroid/view/View;)V

    iput-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->y:Landroid/support/v4/view/w;
...
.method private a()V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/v;
...
.method private f()V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/i;
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->e:Landroid/support/v4/widget/i;
...
.method private g()V
    ...
    iput-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/i;

    new-instance v1, Landroid/support/v4/widget/i;

    invoke-direct {v1, v0}, Landroid/support/v4/widget/i;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->e:Landroid/support/v4/widget/i;
    ...
    :cond_1
    iput-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/i;

    iput-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->e:Landroid/support/v4/widget/i;
...
.method public final a(II)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/v;

    invoke-virtual {p0}, Landroid/support/v4/widget/NestedScrollView;->getScrollX()I

    move-result v3

    invoke-virtual {v2, v3, v1, v4, v0}, Landroid/support/v4/widget/v;->a(IIII)V
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/v;
...
.method a(IIIIIIIIZ)Z
    ...
    iget-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/v;
    ...
    invoke-virtual/range {v1 .. v7}, Landroid/support/v4/widget/v;->a(IIIIII)Z
...
.method public computeScroll()V
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/v;->g()Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/v;->c()I
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/v;->f()F
...
.method public d(I)V
    ...
    invoke-virtual/range {v0 .. v10}, Landroid/support/v4/widget/v;->a(IIIIIIIIII)V
...
.method public dispatchNestedFling(FFZ)Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->y:Landroid/support/v4/view/w;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/i;
    ...
    iget-object v3, p0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/i;

    invoke-virtual {p0}, Landroid/support/v4/widget/NestedScrollView;->getHeight()I

    move-result v4

    invoke-virtual {v3, v2, v4}, Landroid/support/v4/widget/i;->a(II)V

    iget-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/i;
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->e:Landroid/support/v4/widget/i;
    ...
    invoke-virtual {v0, v2, v3}, Landroid/support/v4/widget/i;->a(II)V
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->x:Landroid/support/v4/view/y;
...
.method public onGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {p1, v1}, Landroid/support/v4/view/t;->e(Landroid/view/MotionEvent;I)F
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/support/v4/widget/v;->a(IIIIII)Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, v0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/v;

    invoke-virtual {v2}, Landroid/support/v4/widget/v;->a()Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/v;->h()V
    ...
    iget-object v2, v0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/i;
    ...
    iget-object v2, v0, Landroid/support/v4/widget/NestedScrollView;->e:Landroid/support/v4/widget/i;

    invoke-virtual {v2}, Landroid/support/v4/widget/i;->a()Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/i;->c()Z
    ...
    :cond_10
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/af;->d(Landroid/view/View;)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/ad;->b(Landroid/view/VelocityTracker;I)F
    ...
    invoke-virtual/range {v2 .. v8}, Landroid/support/v4/widget/v;->a(IIIIII)Z
    ...
    :pswitch_5
    invoke-static/range {p1 .. p1}, Landroid/support/v4/view/t;->b(Landroid/view/MotionEvent;)I
