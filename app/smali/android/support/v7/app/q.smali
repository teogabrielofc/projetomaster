...
# static fields
.field private static d:Landroid/support/v7/app/q;
...
.method static a()Landroid/support/v7/app/q;
    .locals 1

    sget-object v0, Landroid/support/v7/app/q;->d:Landroid/support/v7/app/q;
    ...
    sput-object v0, Landroid/support/v7/app/q;->d:Landroid/support/v7/app/q;
...
.method public a(JDD)V
    ...
    iput v2, p0, Landroid/support/v7/app/q;->c:I

    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/app/q;->a:J

    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/app/q;->b:J
    ...
    iput-wide v6, p0, Landroid/support/v7/app/q;->a:J
    ...
    iget-wide v2, p0, Landroid/support/v7/app/q;->b:J

    cmp-long v2, v2, p1

    if-gez v2, :cond_2

    iget-wide v2, p0, Landroid/support/v7/app/q;->a:J
