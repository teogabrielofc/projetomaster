...
.field private w:Landroid/support/v7/app/j$b;
...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/e;)V
    ...
    iput v0, p0, Landroid/support/v7/app/j;->t:I

    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/support/v7/app/j;->v:Z
...
.method private h(I)Z
    ...
    invoke-direct {p0}, Landroid/support/v7/app/j;->y()Z
    ...
    invoke-static {v1}, Landroid/support/v7/app/o;->a(Landroid/content/res/Resources;)Z
...
.method private w()I
    ...
    iget v0, p0, Landroid/support/v7/app/j;->t:I
    ...
    :cond_0
    invoke-static {}, Landroid/support/v7/app/j;->j()I
...
.method private x()V
    ...
    iget-object v0, p0, Landroid/support/v7/app/j;->w:Landroid/support/v7/app/j$b;
    ...
    invoke-static {v1}, Landroid/support/v7/app/r;->a(Landroid/content/Context;)Landroid/support/v7/app/r;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Landroid/support/v7/app/j$b;-><init>(Landroid/support/v7/app/j;Landroid/support/v7/app/r;)V

    iput-object v0, p0, Landroid/support/v7/app/j;->w:Landroid/support/v7/app/j$b;
...
.method private y()Z
    ...
    iget-boolean v2, p0, Landroid/support/v7/app/j;->u:Z
...
.method public c(Landroid/os/Bundle;)V
    ...
    iget v1, p0, Landroid/support/v7/app/j;->t:I
...
.method d(I)I
    ...
    :sswitch_0
    invoke-direct {p0}, Landroid/support/v7/app/j;->x()V
...
.method public i()Z
    ...
    invoke-direct {p0}, Landroid/support/v7/app/j;->w()I

    move-result v1

    invoke-virtual {p0, v1}, Landroid/support/v7/app/j;->d(I)I
    ...
    invoke-direct {p0, v2}, Landroid/support/v7/app/j;->h(I)Z
    ...
    iget-object v1, p0, Landroid/support/v7/app/j;->w:Landroid/support/v7/app/j$b;
    ...
    iput-boolean v1, p0, Landroid/support/v7/app/j;->u:Z
...
.method public o()Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/app/j;->v:Z
