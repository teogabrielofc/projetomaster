.class Landroid/support/v7/widget/RecyclerView$s;
...
.method public constructor <init>(Landroid/support/v7/widget/RecyclerView;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$s;->d:Landroid/support/v4/widget/v;
...
.method private b(IIII)I
    ...
    invoke-direct {p0, v5}, Landroid/support/v7/widget/RecyclerView$s;->a(F)F
...
.method a()V
    ...
    invoke-static {v0, p0}, Landroid/support/v4/view/af;->a(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public a(II)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$s;->d:Landroid/support/v4/widget/v;
...
.method public a(IIII)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Landroid/support/v7/widget/RecyclerView$s;->b(IIII)I
...
.method public b(II)V
    ...
    invoke-virtual {p0, p1, p2, v0, v0}, Landroid/support/v7/widget/RecyclerView$s;->a(IIII)V
...
.method public run()V
    ...
    :cond_0
    invoke-direct {p0}, Landroid/support/v7/widget/RecyclerView$s;->c()V

    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$s;->a:Landroid/support/v7/widget/RecyclerView;

    invoke-static {v0}, Landroid/support/v7/widget/RecyclerView;->c(Landroid/support/v7/widget/RecyclerView;)V

    iget-object v7, p0, Landroid/support/v7/widget/RecyclerView$s;->d:Landroid/support/v4/widget/v;

    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$s;->a:Landroid/support/v7/widget/RecyclerView;

    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/RecyclerView$LayoutManager;

    iget-object v8, v0, Landroid/support/v7/widget/RecyclerView$LayoutManager;->r:Landroid/support/v7/widget/RecyclerView$p;

    invoke-virtual {v7}, Landroid/support/v4/widget/v;->g()Z

    move-result v0

    if-eqz v0, :cond_11

    invoke-virtual {v7}, Landroid/support/v4/widget/v;->b()I

    move-result v9

    invoke-virtual {v7}, Landroid/support/v4/widget/v;->c()I
    ...
    iput v9, p0, Landroid/support/v7/widget/RecyclerView$s;->b:I

    iput v10, p0, Landroid/support/v7/widget/RecyclerView$s;->c:I

    const/4 v2, 0x0

    const/4 v0, 0x0

    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView$s;->a:Landroid/support/v7/widget/RecyclerView;
    ...
    invoke-static {v4}, Landroid/support/v4/e/i;->a(Ljava/lang/String;)V

    if-eqz v11, :cond_1

    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView$s;->a:Landroid/support/v7/widget/RecyclerView;

    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/RecyclerView$LayoutManager;

    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView$s;->a:Landroid/support/v7/widget/RecyclerView;

    iget-object v3, v3, Landroid/support/v7/widget/RecyclerView;->b:Landroid/support/v7/widget/RecyclerView$m;

    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView$s;->a:Landroid/support/v7/widget/RecyclerView;

    iget-object v4, v4, Landroid/support/v7/widget/RecyclerView;->h:Landroid/support/v7/widget/RecyclerView$q;

    invoke-virtual {v2, v11, v3, v4}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->a(ILandroid/support/v7/widget/RecyclerView$m;Landroid/support/v7/widget/RecyclerView$q;)I
    ...
    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->b:Landroid/support/v7/widget/RecyclerView$m;

    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView$s;->a:Landroid/support/v7/widget/RecyclerView;

    iget-object v4, v4, Landroid/support/v7/widget/RecyclerView;->h:Landroid/support/v7/widget/RecyclerView$q;

    invoke-virtual {v0, v12, v1, v4}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->b(ILandroid/support/v7/widget/RecyclerView$m;Landroid/support/v7/widget/RecyclerView$q;)I
    ...
    invoke-virtual {v8}, Landroid/support/v7/widget/RecyclerView$p;->b()Z

    move-result v4

    if-nez v4, :cond_16

    invoke-virtual {v8}, Landroid/support/v7/widget/RecyclerView$p;->c()Z
    ...
    invoke-virtual {v4}, Landroid/support/v7/widget/RecyclerView$q;->e()I

    move-result v4

    if-nez v4, :cond_14

    invoke-virtual {v8}, Landroid/support/v7/widget/RecyclerView$p;->a()V
    ...
    invoke-static {v4}, Landroid/support/v4/view/af;->a(Landroid/view/View;)I
    ...
    :cond_5
    invoke-virtual {v7}, Landroid/support/v4/widget/v;->f()F
    ...
    invoke-virtual {v7}, Landroid/support/v4/widget/v;->d()I
    ...
    invoke-virtual {v7}, Landroid/support/v4/widget/v;->e()I
    ...
    :cond_9
    invoke-virtual {v7}, Landroid/support/v4/widget/v;->h()V
    ...
    :goto_7
    invoke-virtual {v7}, Landroid/support/v4/widget/v;->a()Z
    ...
    invoke-static {v8, v0, v1}, Landroid/support/v7/widget/RecyclerView$p;->a(Landroid/support/v7/widget/RecyclerView$p;II)V
    ...
    :cond_13
    invoke-direct {p0}, Landroid/support/v7/widget/RecyclerView$s;->d()V

    goto/16 :goto_0

    :cond_14
    invoke-virtual {v8}, Landroid/support/v7/widget/RecyclerView$p;->d()I
    ...
    invoke-virtual {v8, v4}, Landroid/support/v7/widget/RecyclerView$p;->a(I)V

    sub-int v4, v11, v2

    sub-int v5, v12, v0

    invoke-static {v8, v4, v5}, Landroid/support/v7/widget/RecyclerView$p;->a(Landroid/support/v7/widget/RecyclerView$p;II)V
