...
.method public constructor <init>()V
    ...
    iput v0, p0, Landroid/support/v7/widget/RecyclerView$q;->b:I
    ...
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$q;->f:I

    iput-boolean v1, p0, Landroid/support/v7/widget/RecyclerView$q;->g:Z

    iput-boolean v1, p0, Landroid/support/v7/widget/RecyclerView$q;->h:Z
...
.method static synthetic a(Landroid/support/v7/widget/RecyclerView$q;)I
    .locals 1
...
.method static synthetic a(Landroid/support/v7/widget/RecyclerView$q;Z)Z
    ...
    iput-boolean p1, p0, Landroid/support/v7/widget/RecyclerView$q;->g:Z
...
.method static synthetic c(Landroid/support/v7/widget/RecyclerView$q;)Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/RecyclerView$q;->i:Z
...
.method static synthetic d(Landroid/support/v7/widget/RecyclerView$q;I)I
    .locals 0

    iput p1, p0, Landroid/support/v7/widget/RecyclerView$q;->e:I
...
.method static synthetic d(Landroid/support/v7/widget/RecyclerView$q;Z)Z
    ...
    iput-boolean p1, p0, Landroid/support/v7/widget/RecyclerView$q;->i:Z

    return p1
.end method

.method static synthetic e(Landroid/support/v7/widget/RecyclerView$q;I)I
    .locals 0

    iput p1, p0, Landroid/support/v7/widget/RecyclerView$q;->b:I
...
.method static synthetic e(Landroid/support/v7/widget/RecyclerView$q;)Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/RecyclerView$q;->g:Z

    return v0
.end method

.method static synthetic e(Landroid/support/v7/widget/RecyclerView$q;Z)Z
    .locals 0
...
.method static synthetic f(Landroid/support/v7/widget/RecyclerView$q;)Z
    .locals 1
...
.method static synthetic f(Landroid/support/v7/widget/RecyclerView$q;Z)Z
    .locals 0
...
.method public c()I
    ...
    iget v0, p0, Landroid/support/v7/widget/RecyclerView$q;->b:I
...
.method public toString()Ljava/lang/String;
    ...
    iget v1, p0, Landroid/support/v7/widget/RecyclerView$q;->b:I
    ...
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$q;->d:Landroid/util/SparseArray;
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/RecyclerView$q;->g:Z
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/RecyclerView$q;->h:Z
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/RecyclerView$q;->i:Z
