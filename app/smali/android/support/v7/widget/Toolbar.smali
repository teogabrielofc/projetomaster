...
.field private I:Landroid/support/v7/widget/bm;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, p2, v1, p3, v7}, Landroid/support/v7/widget/bl;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bl;

    move-result-object v1

    sget v0, Landroid/support/v7/a/a$j;->Toolbar_titleTextAppearance:I

    invoke-virtual {v1, v0, v7}, Landroid/support/v7/widget/bl;->g(II)I
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v7/widget/bl;->c(II)I
    ...
    invoke-virtual {v1, v0, v7}, Landroid/support/v7/widget/bl;->d(II)I

    move-result v0

    sget v2, Landroid/support/v7/a/a$j;->Toolbar_titleMargins:I

    invoke-virtual {v1, v2}, Landroid/support/v7/widget/bl;->g(I)Z
    ...
    invoke-virtual {v1, v2, v0}, Landroid/support/v7/widget/bl;->d(II)I
    ...
    invoke-virtual {v1, v0, v6}, Landroid/support/v7/widget/bl;->d(II)I
    ...
    invoke-virtual {v1, v0, v6}, Landroid/support/v7/widget/bl;->e(II)I
    ...
    invoke-virtual {v1, v0, v8}, Landroid/support/v7/widget/bl;->d(II)I

    move-result v0

    sget v2, Landroid/support/v7/a/a$j;->Toolbar_contentInsetEnd:I

    invoke-virtual {v1, v2, v8}, Landroid/support/v7/widget/bl;->d(II)I

    move-result v2

    sget v3, Landroid/support/v7/a/a$j;->Toolbar_contentInsetLeft:I

    invoke-virtual {v1, v3, v7}, Landroid/support/v7/widget/bl;->e(II)I

    move-result v3

    sget v4, Landroid/support/v7/a/a$j;->Toolbar_contentInsetRight:I

    invoke-virtual {v1, v4, v7}, Landroid/support/v7/widget/bl;->e(II)I

    move-result v4

    invoke-direct {p0}, Landroid/support/v7/widget/Toolbar;->s()V

    iget-object v5, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/bb;

    invoke-virtual {v5, v3, v4}, Landroid/support/v7/widget/bb;->b(II)V
    ...
    :cond_5
    iget-object v3, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/bb;

    invoke-virtual {v3, v0, v2}, Landroid/support/v7/widget/bb;->a(II)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/bl;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/bl;->c(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/bl;->g(I)Z
    ...
    invoke-virtual {v1, v0, v6}, Landroid/support/v7/widget/bl;->b(II)I
...
.method private a(Ljava/util/List;I)V
    ...
    invoke-static {p0}, Landroid/support/v4/view/af;->h(Landroid/view/View;)I
...
.method private s()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/bb;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/bb;
...
.method public a(II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/bb;->a(II)V
...
.method public getContentInsetLeft()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/bb;->a()I
...
.method public getWrapper()Landroid/support/v7/widget/aj;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/bm;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/bm;-><init>(Landroid/support/v7/widget/Toolbar;Z)V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/bm;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/af;->h(Landroid/view/View;)I
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/af;->n(Landroid/view/View;)I
...
.method protected onMeasure(II)V
    ...
    invoke-static {v1}, Landroid/support/v4/view/af;->j(Landroid/view/View;)I

    move-result v1

    invoke-static {v9, v1}, Landroid/support/v7/widget/bp;->a(II)I
    ...
    invoke-static {v0}, Landroid/support/v4/view/af;->j(Landroid/view/View;)I

    move-result v0

    invoke-static {v9, v0}, Landroid/support/v7/widget/bp;->a(II)I
    ...
    invoke-static {v11, v0}, Landroid/support/v7/widget/bp;->a(II)I
    ...
    invoke-static {v4}, Landroid/support/v4/view/af;->j(Landroid/view/View;)I

    move-result v4

    invoke-static {v11, v4}, Landroid/support/v7/widget/bp;->a(II)I
    ...
    invoke-static {v2}, Landroid/support/v4/view/af;->j(Landroid/view/View;)I

    move-result v2

    invoke-static {v11, v2}, Landroid/support/v7/widget/bp;->a(II)I
    ...
    invoke-static {v1, p1, v2}, Landroid/support/v4/view/af;->a(III)I
    ...
    invoke-static {v0, p2, v2}, Landroid/support/v4/view/af;->a(III)I
...
.method public onRtlPropertiesChanged(I)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/bb;

    if-ne p1, v0, :cond_1

    :goto_0
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/bb;->a(Z)V
