...
.field private final B:Landroid/support/v4/view/y;

.field a:Landroid/support/v7/widget/ActionBarContainer;

.field b:Z

.field c:Landroid/support/v4/view/at;

.field final d:Landroid/support/v4/view/ax;
...
.field private i:Landroid/support/v7/widget/aj;
...
.field private y:Landroid/support/v4/widget/v;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->d:Landroid/support/v4/view/ax;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->B:Landroid/support/v4/view/y;

    return-void
.end method

.method private a(Landroid/view/View;)Landroid/support/v7/widget/aj;
    .locals 3
...
.method private a(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/widget/v;
...
.method private a(FF)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/widget/v;
...
.method public a(I)V
    ...
    :sswitch_0
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->i:Landroid/support/v7/widget/aj;

    invoke-interface {v0}, Landroid/support/v7/widget/aj;->f()V
...
.method public a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v7/widget/aj;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
...
.method c()V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->a(Landroid/view/View;)Landroid/support/v7/widget/aj;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->i:Landroid/support/v7/widget/aj;
...
.method d()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->c:Landroid/support/v4/view/at;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v2}, Landroid/support/v4/view/af;->l(Landroid/view/View;)F
...
.method public e()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/aj;->h()Z
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0}, Landroid/support/v4/view/af;->r(Landroid/view/View;)I
    ...
    invoke-static {p0, v1, v2}, Landroid/support/v7/widget/bp;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public getActionBarHideOffset()I
    ...
    invoke-static {v0}, Landroid/support/v4/view/af;->l(Landroid/view/View;)F
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->B:Landroid/support/v4/view/y;
...
.method public j()V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/aj;->m()V
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-static {p0}, Landroid/support/v4/view/af;->s(Landroid/view/View;)V
...
.method protected onMeasure(II)V
    ...
    invoke-static {v9, v2}, Landroid/support/v7/widget/bp;->a(II)I
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/ActionBarOverlayLayout$a;->p()V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/aj;->a(Landroid/view/Window$Callback;)V
