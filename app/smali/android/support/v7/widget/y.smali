...
.field private g:Landroid/support/v7/widget/ao;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p1, p2, v0, p3, v7}, Landroid/support/v7/widget/bl;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bl;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/y;->f:Landroid/content/Context;
    ...
    invoke-static {v2, p2, v5, p3, v7}, Landroid/support/v7/widget/bl;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bl;
    ...
    invoke-virtual {v2, v5, v6}, Landroid/support/v7/widget/bl;->f(II)I
    ...
    invoke-virtual {v2, v5}, Landroid/support/v7/widget/bl;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v4, v5}, Landroid/support/v7/widget/bl;->d(I)Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v0, v5}, Landroid/support/v7/widget/y$b;->a(Ljava/lang/CharSequence;)V
    ...
    iput-object v2, p0, Landroid/support/v7/widget/y;->g:Landroid/support/v7/widget/ao;

    :cond_2
    sget v0, Landroid/support/v7/a/a$j;->Spinner_android_entries:I

    invoke-virtual {v4, v0}, Landroid/support/v7/widget/bl;->f(I)[Ljava/lang/CharSequence;
    ...
    :cond_3
    invoke-virtual {v4}, Landroid/support/v7/widget/bl;->a()V
    ...
    invoke-virtual {v4, v0, v7}, Landroid/support/v7/widget/bl;->g(II)I
    ...
    iput-object v2, p0, Landroid/support/v7/widget/y;->f:Landroid/content/Context;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/y;->g:Landroid/support/v7/widget/ao;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/y;->g:Landroid/support/v7/widget/ao;

    invoke-virtual {v0, p0, p1}, Landroid/support/v7/widget/ao;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
