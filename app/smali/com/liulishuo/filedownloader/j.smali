...
.method private b(Lcom/liulishuo/filedownloader/s;)V
    .locals 3
...
.method private c(Lcom/liulishuo/filedownloader/s;)V
    .locals 2
...
# virtual methods
.method a(Lcom/liulishuo/filedownloader/s;)V
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0}, Lcom/liulishuo/filedownloader/j;->a(Lcom/liulishuo/filedownloader/s;Z)V

    return-void
.end method

.method a(Lcom/liulishuo/filedownloader/s;Z)V
    .locals 3

    invoke-interface {p1}, Lcom/liulishuo/filedownloader/s;->c()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-interface {p1}, Lcom/liulishuo/filedownloader/s;->b()V

    :goto_0
    return-void

    :cond_0
    invoke-interface {p1}, Lcom/liulishuo/filedownloader/s;->d()Z
    ...
    invoke-direct {v1, p0, p1}, Lcom/liulishuo/filedownloader/j$1;-><init>(Lcom/liulishuo/filedownloader/j;Lcom/liulishuo/filedownloader/s;)V
    ...
    invoke-direct {p0, v0}, Lcom/liulishuo/filedownloader/j;->b(Lcom/liulishuo/filedownloader/s;)V
    ...
    :cond_4
    invoke-direct {p0, p1}, Lcom/liulishuo/filedownloader/j;->b(Lcom/liulishuo/filedownloader/s;)V

    goto :goto_0

    :cond_5
    invoke-direct {p0, p1}, Lcom/liulishuo/filedownloader/j;->c(Lcom/liulishuo/filedownloader/s;)V
