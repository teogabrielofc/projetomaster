...
.method constructor <init>(Lb/f;Lokhttp3/MediaType;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lokhttp3/MultipartBody;->boundary:Lb/f;
    ...
    invoke-virtual {p1}, Lb/f;->a()Ljava/lang/String;
...
.method private writeOrCountBytes(Lb/d;Z)J
    ...
    iget-object v0, p0, Lokhttp3/MultipartBody;->boundary:Lb/f;
    ...
    invoke-interface {p1, v6}, Lb/d;->b(Ljava/lang/String;)Lb/d;
    ...
    invoke-interface {v6, v0}, Lb/d;->b(Ljava/lang/String;)Lb/d;

    move-result-object v0

    sget-object v6, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {v0, v6}, Lb/d;->c([B)Lb/d;
    ...
    invoke-interface {v0, v8, v9}, Lb/d;->l(J)Lb/d;
    ...
    :cond_5
    invoke-virtual {v7, p1}, Lokhttp3/RequestBody;->writeTo(Lb/d;)V
...
.method public contentLength()J
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lb/d;Z)J
...
.method public writeTo(Lb/d;)V
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lb/d;Z)J
